...
import CorporateUpdateDetails from './corporate-dashboard/CorporateUpdateDetails';
...
const CorporateDashboardPage: React.FC = () => {
  ...
  const completedJourneys = mockJourneys.filter((j) => j.status === 'Completed');
      ...
      case 'Complain':
        return (
          <DashboardContentWrapper title="Submit a Complaint">
            <ClientComplain completedJourneys={completedJourneys} />
          </DashboardContentWrapper>
        );
      case 'Review':
        return (
          <DashboardContentWrapper title="Leave a Review">
            <ClientReview completedJourneys={completedJourneys} />
          </DashboardContentWrapper>
        );
      case 'Lost property':
        return (
          <DashboardContentWrapper title="Report Lost Property">
            <ClientLostProperty completedJourneys={completedJourneys} />
          </DashboardContentWrapper>
        );
      case 'Update Details':
        return (
